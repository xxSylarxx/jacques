    ...
    <style>
        #portada {
            background-image: linear-gradient(to bottom, rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.2)),
                url('./public/img/web/b-inicial.png');
 ...
 */
    ...
    <div class="container-fluid" id="portada">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h2 class="page_title">NIVEL INICIAL</h2>
    ...
    <section id="bienvenidos">
        <div class="container-fluid">
            <div class="row d-flex justify-content-center">
                <div class="col-lg-6 " style="background-color: var(--color3);padding-right:30px;">
                    <!--   <br>
                    <div class="py-5">
                    ...
                    <br>
                    <br>
                    <div class="scroll" style="padding:3rem;">
                        <p>Desde muy pequeños fomentamos la creatividad, la exploración, el juego y la experimentación en nuestros niños, desarrollando sus
                            capacidades y aptitudes para resolver problemas en su vida futura. Además, en Kínder se inicia la experiencia bilingüe,
                            la cual les permite absorber naturalmente los sonidos y las estructuras de dos idiomas. Se ayuda a los niños a adquirir
                            competencia en inglés lo antes posible poniendo especial énfasis en hablar y escuchar, así como en actividades de lectura y escritura.
                            Esto establece una base sólida para el aprendizaje futuro y les da una ventaja invaluable a medida que avanzan en su educación.
                            Está comprobado que la inmersión temprana a diferentes idiomas estimula el desarrollo cognitivo y promueve la creatividad y la flexibilidad mental.</p>
                        <p>
                            En Matemáticas se desarrollan aspectos importantes del entendimiento matemático y se proporciona la base para la numeración. Esto se logra a través de actividades prácticas y mediante el uso y entendimiento del lenguaje matemático simple.
                        </p>
                        <p>En Personal Social los niños adquieren un conocimiento básico y comprensión de su entorno, otras personas y características del mundo natural y hecho por el hombre.</p>
                        <p>El curso de Psicomotricidad tiene como objetivo ayudar a los niños a desarrollar control físico, movilidad, conciencia del espacio y habilidades manipulativas en entornos interiores y exteriores. Se anima activamente a los niños a establecer actitudes positivas hacia un estilo de vida saludable y activo.</p>
                ...
                <div class="col-lg-6 px-0">
                    <div class="image-box">
                        <img src="./public/img/web/portada_inicial.jpg" alt="">
        ...
        <div class="container-fluid" style="padding:4%;">
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-lg-2 py-5 d-flex justify-content-center"><a href="./alianzas.php">
                        <center><img src="./public/img/web/alianzas/cambridge.png" width="80%" alt=""></center>
                    </a></div>
                <div class="col-lg-2 py-5 d-flex justify-content-center"><a href="./alianzas.php">
                        <center><img src="./public/img/web/alianzas/global.png" width="80%" alt=""></center>
                    </a></div>
                <div class="col-lg-2 py-5 d-flex justify-content-center"><a href="./alianzas.php">
                        <center><img src="./public/img/web/alianzas/education.png" width="80%" alt=""></center>
                    </a></div>
                <div class="col-lg-2 py-5 d-flex justify-content-center"><a href="./alianzas.php">
                        <center><img src="./public/img/web/alianzas/learning.png" width="80%" alt=""></center>
                    </a></div>
                <div class="col-lg-2 py-5 d-flex justify-content-center"><a href="./alianzas.php">
                        <center><img src="./public/img/web/alianzas/admision.png" width="80%" alt=""></center>
                    </a></div>
                <div class="col-lg-2 py-5 d-flex justify-content-center"><a href="./alianzas.php">
