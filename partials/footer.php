    ...
    <div class="container-fluid py-4" style="padding-left:3%;padding-right:3%;">
        <div class="row">
            ...
            <div class="col-lg-3 py-2 px-1">
                ...
                <!-- <div class="d-flex justify-content-start text-black pt-5">
                    <img src="./public/img/icons/book_reclamo.png" alt="" style="width:20%;height:auto;">
                    <a href="https://docs.google.com/forms/d/e/1FAIpQLScoNRFs-jb1RUQw7qH0th8b3l6M0GXvhIyJdvSp4UyJlFaxnQ/viewform" target="_blank" class="my-auto">Libro de Reclamaciones</a>
                </div>  -->

            </div>
            <div class="col-lg-4 py-2 px-5">
                <h4 class="text-start" style="color:var(--color1);">CONTÁCTANOS</h4>
                <div class="d-flex justify-content-start py-1" style="color:var(--color1);font-family: 'Raleway', sans-serif;"><i class="fas fa-location-arrow" style="color:var(--color2);font-size:.8rem;"></i><a href="https://www.google.com/maps/place/Av.+Separadora+Industrial+3250,+Lima+15012/@-12.0576405,-76.9474137,17z/data=!3m1!4b1!4m6!3m5!1s0x9105c694e7fbe8f1:0x3a08562c20d83bfd!8m2!3d-12.0576458!4d-76.9448388!16s%2Fg%2F11j37dknmh?entry=ttu&g_ep=EgoyMDI1MDQwMi4xIKXMDSoJLDEwMjExNDUzSAFQAw%3D%3D" style="color:var(--color1);" target="_blank">
                        <p class="text-start" style="margin-top: -5px; margin-bottom:0px;">&nbsp;&nbsp;Avenida Separadora Industrial #3250 <br> La Molina, Lima - Perú</p>
                </div>
                ...
                <div class="d-flex justify-content-start text-black pt-5">
                    <img src="./public/img/icons/book_reclamo.png" alt="" style="width:30%;height:auto;">
                    <a href="https://docs.google.com/forms/d/e/1FAIpQLScoNRFs-jb1RUQw7qH0th8b3l6M0GXvhIyJdvSp4UyJlFaxnQ/viewform" target="_blank" class="my-auto">Libro de Reclamaciones</a>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col d-flex justify-content-start align-items-center">
                <p class="my-1 text-center" style="font-size: 15px; color:var(--color1)">Jacques Cousteau © 2025 </p>
                <p class="my-1 text-center px-3" style="font-size:15px; color:var(--color1)"><a href="./public/files/politicas-priv-jacques.pdf" target="_blank">Conoce nuestras Politicas de Privacidad</p>
                </a>
                </div>
