    ...
    <div class="container-fluid py-4" style="padding-left:3%;padding:4%;">
        <div class="row ">
            ...
            <div class="col-lg-4 py-2 px-5">
                ...
                <div class="d-flex justify-content-start py-1" style="color:var(--color3);font-family: 'Raleway', sans-serif;"><i class="fas fa-location-arrow" style="color:var(--color2);font-size:.8rem;"></i>&nbsp;&nbsp;<p class="text-start" style="margin-top: -5px; margin-bottom:0px;">&nbsp;&nbsp;Avenida Separadora Industrial #3250 <br> La Molina, Lima - Perú</p>
                </div>
                <div class="d-flex justify-content-start py-1" style="color:var(--color3);font-family: 'Raleway', sans-serif;"><i class="fas fa-phone-alt my-auto" style="color:var(--color2);font-size:.8rem;"></i>&nbsp;&nbsp;(51) 948 886 928</div>
